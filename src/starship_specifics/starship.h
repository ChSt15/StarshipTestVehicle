...
public:
    ...
    Starship(Guidance_Interface* guidancePointer, Navigation_Interface* navigationPointer, StarshipControl* controlPointer, StarshipDynamics* dynamicsPointer) : Task_Abstract("Starship Vehicle", 1000, eTaskPriority_t::eTaskPriority_High) {
