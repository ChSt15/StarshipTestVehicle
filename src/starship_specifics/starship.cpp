...
void Starship::init() {
    ...
    control_->setAttitudePIDFactors(Vector(20,20,5), Vector(1,1,1), Vector(0), Vector(1000), true);
    control_->setPositionPIDFactors(Vector(0,0,20), Vector(0,0,1), Vector(0), Vector(1000), true);
